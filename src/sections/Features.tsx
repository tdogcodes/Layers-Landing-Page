        ...
        <section className="py-24" id="features">
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                        ...
                        <div className="aspect-video flex items-center justify-center ">
                            ...
                            <Avatar className="-ml-6 border-transparent group-hover:border-green-500 transition">
                                <div className="size-full bg-neutral-700 rounded-full inline-flex items-center justify-center gap-1 relative">
                                    <Image src={Avatar4} className="absolute size-full rounded-full opacity-0 group-hover:opacity-100 transition" alt='avatar 4' />
                    ...
                    <FeatureCard title="Keyboard Quick Actions" description="Powerful commands to help you create designs more quickly" className="group md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-start-auto">
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 outline outline-2 outline-offset-4 hover:translate-y-1 outline-transparent group-hover:outline-lime-400 transition-all">Shift</Key>
                            <Key className="outline outline-2 outline-offset-4 hover:translate-y-1 outline-transparent group-hover:outline-lime-400 duration-300 transition-all">Alt</Key>
                            <Key className="outline outline-2 outline-offset-4 hover:translate-y-1 outline-transparent group-hover:outline-lime-400 duration-300 transition-all">C</Key>
                        </div>
                    </FeatureCard>
                </div>
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        <div key={feature} className="bg-neutral-900 border border-white/10 inline-flex px-3 md:px-5
                        hover:scale-105 transition duration-500 py-1.5 md:py-2 rounded-2xl gap-3 items-center group">
                            <span className="bg-lime-400 text-xl text-neutral-950 size-5 rounded-full inline-flex items-center justify-center group-hover:rotate-90 transition duration-500">&#10038;</span>
