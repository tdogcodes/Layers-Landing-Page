        ...
        <section className="py-24 ">
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8">
                    <FeatureCard title="Real-time Collaboration" description="Work together seamlessly with conflict-free team editing" className="col-span-2">
                    ...
                    <FeatureCard title="Interactive Prototyping" description="Engage your clients with prototypes that react to user actions" className="col-span-2">
                    ...
                    <FeatureCard title="Keyboard Quick Actions" description="Powerful commands to help you create designs more quickly" className="col-span-2 col-start-2">
