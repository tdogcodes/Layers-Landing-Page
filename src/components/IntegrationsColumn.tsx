...
export default function IntegrationsColumn ( props: {
    ...
    return (
        <motion.div initial={{y: reverse ? '-50%' : 0 }} animate={{y: reverse ? 0 : '-50%'}} transition={{duration: 15, ease: "linear", repeat: Infinity}} className={twMerge("flex flex-col gap-4 pb-4", className)}>
